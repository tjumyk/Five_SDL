...
void drawSettingBox( const int &mX, const int &mY ) 
{
	...
	case 0:apply_surface(660,213,str_player,screen);break;
	case 1:apply_surface(660,213,str_innerAI,screen);break;
	case 2:apply_surface(660,213,str_outerAI,screen);break;
	}
	apply_surface(640,273,str_white,screen);
	switch(game->getPlayer(2)){
	case 0:apply_surface(660,313,str_player,screen);break;
	case 1:apply_surface(660,313,str_innerAI,screen);break;
	case 2:apply_surface(660,313,str_outerAI,screen);break;
	}
}
